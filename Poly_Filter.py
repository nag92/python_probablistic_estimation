...
class Poly_Filter(object):
	'''
	This is a polynmoail least squares filter. It fits a n degree polynomial to a set of data and use a goodness of fit
	to determin if the new data point fits on the line. 
	'''
